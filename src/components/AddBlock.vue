...
export default {
    ...
    methods:{
        add () { //когда вызывается метод эдд он должен высывать событие  add-block-item
this.$emit("add-block-item",this.nameBlock);// отправляем событие(генерируем) и передаем его родителю 
this.nameBlock="";
}
    }
}
